...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_joint_state(self):
    ...
    joint_goal[2] = -0.646702
    joint_goal[3] = -2.87913
    joint_goal[4] = -0.692478
    joint_goal[5] = 2.30858
    joint_goal[6] = 1.99567
  ...
  def go_to_pose_goal(self):
    ...
    pose_goal.orientation.x = -0.710148966568
    pose_goal.orientation.y = 0.64982932398
...
def main():
  try:
    ...
    while True:
      ...
      print "============ Press `1` to go to FIRST joint state goal ..."
      print "============ Press `2` to go to SECOND pose state goal ..."
      choice = raw_input()
      choice = int(choice)
      ...
      if choice == 0:
        ...
        print "going to FIRST joint state goal ..."
        tutorial.go_to_joint_state()
	
      elif choice == 2:
        print "going to SECOND pose state goal ..."
